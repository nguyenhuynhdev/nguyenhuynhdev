...
export default function EditBlogPage() {
  ...
  // Get post_id from URL query parameter (for static export compatibility)
  ...
  // Get post_id from URL query parameter (works with static export)
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (id) {
        ...
        // If no post_id found, redirect to blogs page
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      apiClient.get<{ success: boolean; data: any }>(`/blogs/${postId}`),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const slugWithoutId = formData.slug.replace(/-?\d+$/, '');
      await apiClient.put(`/blogs/${postId}`, {
        ...formData,
        slug: slugWithoutId,
